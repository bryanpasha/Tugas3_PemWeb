...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      ...
      <div>
        <a href="Forum.php" class="btn btn-success me-5">Form Registrasi</a>
      </div>  
    </div>
</nav>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Hapus.php?id=' . $row['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin mau hapus data ini?\')"> <i class="bi bi-trash"></i> </a>
                        </td>
                    </tr>
                    ';
                }
